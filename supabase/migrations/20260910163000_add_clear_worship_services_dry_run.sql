-- Adiciona simulacao transacional para validar a limpeza sem persistir exclusoes.

drop function if exists public.clear_all_worship_services(uuid);

create function public.clear_all_worship_services(
  actor_id uuid,
